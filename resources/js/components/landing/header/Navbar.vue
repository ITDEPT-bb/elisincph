    ...
    <ul class="hidden items-center gap-6 lg:flex">
      <li v-for="(link, index) in links" :key="index">
        <a
          ...
          :class="
            link.current
              ? 'text-[11px] font-semibold text-bright-green underline underline-offset-4 lg:text-[12px] xl:text-[14px] dark:text-white'
              : 'text-[11px] font-medium text-neutral-900 underline-offset-4 hover:text-bright-green hover:underline lg:text-[12px] xl:text-[14px] dark:text-neutral-300 dark:hover:text-white'
          "
        >
          {{ link.label }}
        </a>
      ...
      >
        <li v-for="(link, index) in links" :key="index" class="py-4">
          <a
            ...
            :class="
              link.current
                ? 'text-md font-bold text-dark-green dark:text-white'
                : 'text-md text-neutral-900 dark:text-neutral-300'
            "
          >
            {{ link.label }}
          </a>
